...
* https://issues.redhat.com/secure/ReleaseNote.jspa?projectId=12322421&version=12353773[{PRODUCT} {COMMUNITY_VERSION_FINAL}]
** https://issues.redhat.com/secure/ReleaseNote.jspa?projectId=12322421&version=12357531[{PRODUCT} tooling 0.10.0]
...
* Changed Management/Task console's authenicaition mechanism. Now, the consoles use keycloak for authentication.
...
==== Support for Task Assigning Service in {PRODUCT}
...
For more information about Task Assigning Service, see {URL_CONFIGURING_KOGITO}#con-kogito-task-assigning-service_kogito-configuring[_{PRODUCT} Task Assigning Service_].
